...
from products.views import list_products, create_product,search_products,descripction_product,borrar_product,update_product
...
urlpatterns = [
    ...
    path("borrar-product/<int:id>/",borrar_product,name="borrar-product" ),
